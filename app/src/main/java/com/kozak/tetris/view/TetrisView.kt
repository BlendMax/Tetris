...
import com.kozak.tetris.GameActivity
import com.kozak.tetris.constants.CellConstants
import com.kozak.tetris.constants.FieldConstants
import com.kozak.tetris.model.AppModel
import com.kozak.tetris.model.Block

// TetrisView - the user interface with which the user plays tetris.
...
// Sets the current move command to be executed by the game.
    ...
    override fun onSizeChanged(width: Int, height: Int, previousWidth: Int, previosHeight: Int) {
        super.onSizeChanged(width, height, previousWidth, previosHeight)
...
// Custom handler for TetrisView, which meets the needs of the view when sending and processing messages.
...
// The Dimension class is needed to include two properties in the code: width and height.
